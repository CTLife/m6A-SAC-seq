...
my $HELP = '
        ...
        Step 1: This script will directly assess the quality of raw reads to identify possible experimental and sequencing errors or biases 
                ...
                The versions of softwares and packages are used in this script (They are shown for reference only. And do not need to match them.):  
                        Perl,   5.34.0   (perl    -v)
        ...
        Usage:
               perl  m6A-SAC-seq_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time perl  m6A-SAC-seq_1.pl    -in 1_rawFASTQ   > m6A-SAC-seq_1.runLog.txt  2>&1  & 
...
## Version Infromation
my $version = "    The 1st Step, version 1.4,  2022-08-05.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  m6A-SAC-seq_1.pl  -help' \n";
    exit 0;
}
