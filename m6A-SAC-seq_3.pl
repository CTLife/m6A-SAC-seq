...
my $HELP = '
        ...
        Usage:
               perl m6A-SAC-seq_3.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               perl m6A-SAC-seq_3.pl   -in 2-removedAdapters   -out 3-removedDups    > m6A-SAC-seq_3.runLog.txt  2>&1   
...
## Version Infromation
my $version = "    The 3rd Step, version 1.4,  2022-08-05.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl m6A-SAC-seq_3.pl  -help' \n";
    exit 0;
}
