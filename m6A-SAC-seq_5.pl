...
my $HELP = '
        ...
        Usage:
               m6A-SAC-seq_5.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]  [-mis mismatch] 
        For instance:
               m6A-SAC-seq_5.pl   -genome hg38   -in 4-finalFASTQ   -out 5-rawBAM  -mis 0.2    > m6A-SAC-seq_5.runLog
...
## Version Infromation
my $version = "    The 4th Step, version 1.0.0,  2020-03-01";
